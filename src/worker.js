...
function piSupportChannel(nonce) {
  ...
  const amount = ${PI_SUPPORT_CHANNEL_AMOUNT}, memo = ${JSON.stringify(PI_SUPPORT_CHANNEL_MEMO)}, metadata = ${JSON.stringify(PI_SUPPORT_CHANNEL_METADATA)}, scopes = ["username", "payments", "roles", "in_app_notifications"]; let authorization = '', busy = false, initialized = false, incompletePayment = null;
