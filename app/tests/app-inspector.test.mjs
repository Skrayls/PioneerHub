...
assert.match(workerSource, /const FRONTEND_BUILD = "merchant-readiness-desk-v1"/);
assert.match(config, /"RELEASE_ID": "2026-08-22-merchant-readiness-desk-v1"/);
...
assert.match(html, /app-inspector\.css\?v=merchant-readiness-desk-v1/);
assert.match(html, /app-inspector\.js\?v=merchant-readiness-desk-v1/);
