...
assert.match(js, /const FRONTEND_BUILD = 'community-signals-v1'/);
...
const shell = await worker.fetch(new Request('https://example.test/?build=community-signals-v1'), {
...
assert.match(shellHtml, /styles\.css\?v=community-signals-v1/);
assert.match(shellHtml, /app\.js\?v=community-signals-v1/);
...
assert.match(workerSource, /const FRONTEND_BUILD = "community-signals-v1";/, 'Community Signals build marker must be current');
